...
type GLContext = any; // OGL GL context type
type OGLMesh = any;   // OGL Mesh type
type OGLRenderer = any; // OGL Renderer type
type OGLProgram = any;  // OGL Program type
type OGLGeometry = any; // OGL Geometry type
type OGLTransform = any; // OGL Transform type
...
class App {
    ...
    onWheel(e: WheelEvent) {
        // @ts-ignore - wheelDelta might not exist on types but exists in some browsers
